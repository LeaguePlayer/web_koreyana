...
$cs->registerScriptFile($this->getAssetsUrl().'.js/captcha.js', CClientScript::POS_END);
$cs->registerScriptFile($this->getAssetsUrl().'.js/jquery-ui-1.10.4.custom.min.js', CClientScript::POS_END);
