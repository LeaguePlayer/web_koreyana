<?php
/**
 * Миграция m140421_053847_education
 *
 * @property string $prefix
 */
 
class m140421_053847_education extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{education}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{education}}', array(
            ...
            'dt_end'=>"string COMMENT 'Дата окончания'",
