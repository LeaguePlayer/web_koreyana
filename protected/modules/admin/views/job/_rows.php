	...
	<?php echo $form->textFieldControlGroup($model,'preview',array('class'=>'span8','maxlength'=>255)); ?>
	...
	<?php echo $form->dropDownListControlGroup($model, 'status', job::getStatusAliases(), array('class'=>'span8', 'displaySize'=>1)); ?>
